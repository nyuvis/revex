...
Tex.controller('texCtrl', function ($scope, es, $sce) {
    ...
    $scope.facets = [
        {order: 1, title: "Rating Clarity", field: "document.rating_Clarity", directive: "rating"},
        {order: 1, title: "Rating Easiness", field: "document.rating_Easiness", directive: "rating"},
        {order: 1, title: "Rating Helpful", field: "document.rating_Helpful", directive: "rating"},
    ...
    //        script: "doc['business.review_count'].value > 5 ? (doc['business.review_count'].value > 10 ?              (doc['business.review_count'].value > 100 ? '>100' : '>10') : '>5') : doc['business.review_count'].value"},
        {order: 3, title: "Institution", field: "entity.Institution", directive: "provider"},
        {order: 3, title: "Department", field: "entity.Department", directive: "provider"},
        {order: 3, title: "Professor", field: "entity.name", directive: "provider"},
        
        {order: 4, title: "textBook", field: "document.textBook", directive: "provider"},
        {order: 5, title: "attendance", field: "document.attendance", directive: "provider"},
        {order: 6, title: "grade", field: "author.grade", directive: "provider"},
        {order: 7, title: "interest", field: "author.interest", directive: "provider"},
        {order: 8, title: "takenForCredit", field: "author.takenForCredit", directive: "provider"}
  ...
  //      {order: 5, title: "State", field: "business.state", directive: "provider"}
    ...
    $scope.readUrl = function () {
        ...
        $scope.filter.date = $scope.filter.date || {
            from: {desc: moment.utc(0).format("MMM YYYY"), stamp: es.stats.dateMin.value},
            to: {desc: moment.utc(0).format("MMM YYYY"), stamp: es.stats.dateMax.value},
            maxExtent: true
        };
        $scope.loadData();
    };
